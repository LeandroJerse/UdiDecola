...
public class PartnerEmployeeAccount extends EmployeeAccount {
    ...
    public PartnerEmployeeAccount(String fullName, String cPF, String fullAdress, String birthday,String password,String workCardNumber,double stantardSalary){
    super(fullName, cPF, fullAdress, birthday,password, workCardNumber, stantardSalary);
