...
import javax.swing.table.DefaultTableModel;
 ...
 public class LobShowFlightLeg extends javax.swing.JInternalFrame {

    AccountAirline airline;
    
    public LobShowFlightLeg(AccountAirline airline) {
    ...
    private void jBUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBUpdateActionPerformed
        ...
        for(Flight item: FlightLegDAO.flightLegs){
            if(item.getAirline().equals(airline)){
            
            DefaultTableModel tbFlightLegs = (DefaultTableModel) jTaFlightLegs.getModel();


            Object[] dados = {item.getIdentifierCode(),(Double)item.getTicketPrice(),(Integer)item.getAvailableSeats()};
